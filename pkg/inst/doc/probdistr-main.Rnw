...
\SweaveInput{probdistr-discrete}

\SweaveInput{probdistr-discrextra}

\part{Continuous distributions}

\SweaveInput{probdistr-finitesupp}

\SweaveInput{probdistr-gaussian}

\SweaveInput{probdistr-exp}

\SweaveInput{probdistr-chi}

\SweaveInput{probdistr-student}

\SweaveInput{probdistr-pareto}

\SweaveInput{probdistr-logis}

\SweaveInput{probdistr-gumbel}

\part{Multivariate and generalized distributions}

\SweaveInput{probdistr-general}

\SweaveInput{probdistr-mult}

\SweaveInput{probdistr-misc}
