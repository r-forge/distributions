...
%\VignetteIndexEntry{Handbook on probability distributions}
%\VignettePackage{probdistr}
...
{\normalsize 	R powered %\includegraphics[scale=1]{img/Rlogo.jpg}
				\hfill 
			R-forge project %\includegraphics[scale=0.35]{img/Rforgelogo.png}
}
...
\HRule\\
	...
	\vspace{4pt}
	\Large University Year 2009-2010\\
	\vspace{4pt}	
\end{center}
\vspace{200pt}
...
\SweaveInput{src/probdistr-intro}
...
\SweaveInput{src/probdistr-discrete}

\SweaveInput{src/probdistr-discrextra}
...
\SweaveInput{src/probdistr-finitesupp}

\SweaveInput{src/probdistr-gaussian}

\SweaveInput{src/probdistr-exp}

\SweaveInput{src/probdistr-chi}

\SweaveInput{src/probdistr-student}

\SweaveInput{src/probdistr-pareto}

\SweaveInput{src/probdistr-logis}

\SweaveInput{src/probdistr-gumbel}
...
\SweaveInput{src/probdistr-general}

\SweaveInput{src/probdistr-mult}

\SweaveInput{src/probdistr-misc}
...
\newpage
\appendix
\SweaveInput{src/probdistr-math}
